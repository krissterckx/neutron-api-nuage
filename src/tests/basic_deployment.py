...
class NeutronApiNuageCharmDeployment(
    ...
    def _add_services(self):
        """Add services
           ...
           """
        this_service = {'name': 'neutron-api-nuage'}
        other_services = [
            {
                'name': 'nova-compute',
                'constraints': {'mem': '4G'},
    ...
    def _add_relations(self):
        ...
        relations = {
            'nova-compute:neutron-plugin': 'neutron-api-nuage:neutron-plugin',
            ...
            'neutron-gateway:juju-info': 'neutron-api-nuage:container',
        }
        super(NeutronApiNuageCharmDeployment, self)._add_relations(relations)
